...
def oci_pull(name, image = None, repository = None, registry = None, platforms = None, digest = None, tag = None, reproducible = True, is_bzlmod = False, config = None, config_path = None, cred_helper = None):
    ...
    Args:
        ...
        config: label to a text file that contains your docker config file
        ...
        cred_helper: label to a text file that is being used for authentication, this file should be executable, by default this argument is ignored
    """
